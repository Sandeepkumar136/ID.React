...
export default function HomeTyper(props) {
  const words = [
    "Frontend Developer",
    "Backend Developer",
    "Fullstack Developer",
  ...
  return (
    <>
      ...
      <h1 className="global-heading">Recommended courses</h1>
      <article className="article">
        <div className="course-card">
          <div className="course-img-contain">
            <img
              src="https://i.ibb.co/Hx56hSL/IN-Git-Hub-1.jpg"
              alt=""
          ...
          <div className="text-contain-course">
            ...
            <p className="text-course">
              This latest Node.js course comes with premium curriculum that
              covers everything from basics to advance. On top of that, you will
              get my handwritten notes of Node.js for completely free. What are
              you waiting for? Just Enroll Buddy
            </p>
        ...
        <div className="course-card">
          <div className="course-img-contain">
            <img
              src="https://i.ibb.co/xLD97cD/IN-Git-Hub.jpg"
              alt=""
              className="course-img"
            />
          </div>
        ...
        <div className="course-card">
          <div className="course-img-contain">
            <img
              src="https://i.ibb.co/jrxjdMM/IN-Git-Hub-2.jpg"
              alt=""
              className="course-img"
            />
          </div>
      ...
      <article className="testimonials">
        <div className="testi-card">
          ...
          <p className="text-testi">
            I highly recommend BLACKBOX Web Solutions for anyone looking for
            top-notch web development services. Their commitment to excellence,
            combined with their creative approach and technical proficiency,
            makes them the ideal partner for bringing your digital vision to
            life.
          </p>
        ...
        <div className="testi-card">
          ...
          <p className="text-testi">
            The team at Black Web Solutions took the time to truly understand
            our business objectives and target audience, ensuring that the
            website not only looked fantastic but also effectively communicated
            our brand message. They were responsive to our feedback throughout
            the entire process and went above and beyond to exceed our
            expectations.
          </p>
          <h2 className="testi-heading">
            Rishav kumar
