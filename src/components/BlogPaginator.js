        ...
        {blogs.slice(0, currentPage).map((element) => (
          <div key={element.id} className="Blogcard">
            <div className="bc-up-contain">
              <img src={element.img} alt="BlogLogo" className="logo-b" />
              <div className="title-b">{element.username}</div>
              <div className="b-dep-date">{element.date}</div>
            </div>
            <div className="b-base-contain">
              <div className="b-base-title">{element.title}</div>
              <div className="b-b-disc">{element.description}</div>
              <div className="b-b-base-link">
                <a href={element.link} className="b-b-link">
                  view in blogspot
                </a>
              </div>
            </div>
